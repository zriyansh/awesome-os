...
| 51.  | Nightwave Plaza             | Nightwave Plaza is a free 24/7 online old Windows inspired vaporwave radio station. The broadcast also includes some future funk and experimental genres. We hope you enjoy.                      | [here](https://plaza.one)                      |
...
| 57.  | win95              | Windows95 replica with a cat! Visit decades old webpage of popular sites like Apple and Google.              | [here](https://derplayer.neocities.org/repo/win/#)                      |
| 58.  | [The Indie Web](https://github.com/tholman/the-indie-web)       |  A windows inspired blogging site      <br>   `CSS` `HTML` `JS` ~ [@tholman](https://github.com/tholman)               | [here](https://theindieweb.com)                      |
...
| 60.  | Windows 1.0            | Here you can find everything there is to know about the first version of Windows.   <br>  `PHP`               | [here](https://win1.krnl386.com)                      |
...
| 64.  | tetrageddon              | A chaotic version of win OS, warning- lots of popups.                       | [here](http://tetrageddon.com)                      |
...
| 29.  | [x](https://github.com/DustinBrett/x)              | Desktop environment in the browser. A crossover between Windows 10 and macOS <br>  `TS` `JS` ~ [@DustinBrett](https://github.com/DustinBrett)                      | [here](https://x.dustinbrett.com)                      |
...
| 09.  | [D-Antonelli](https://github.com/D-Antonelli/portfolio)              | This is a retro-inspired personal OS, responsive website with client-side applications. <br>  `SCSS` `HTML` `JS` ~ [@D-Antonelli](https://github.com/D-Antonelli)                      | [here](https://elkael.com)                      |
...
| 30.  | [melkael.github.io](https://github.com/melkael/melkael.github.io)              | A win7 based resume <br>  `CSS`  `HTML` `JS` ~ [@melkael](https://github.com/melkael)                      | [here](https://elkael.com)                      |
...
| 32.  | [homepage](https://github.com/v-y-l/Homepage)              | My personal website <br>  `TS` `CSS` `HTML` `JS` ~ [@v-y-l](https://github.com/v-y-l)                      | [here](https://www.vyl.app)                      |
...
| 39.  | [Hannah Blair](https://github.com/hannahblair)              | A Windows95 inspired portfolio website                   | [here](https://hannahblair.co.uk)                      |
| 40.  | [Aimen Rafique–Marsh  ◠‿◠ ✿](https:fdfdfdfdf)              | some kind of cool blog                     | [here](https://blog.aimen.me)                      |
| 41.  | Britney OS’99  | A bots OS based website to vote  Britney in a past US elections.                    | [here](https://web.archive.org/web/20210105054008/http://itsbritneybot.com/)                      |
...
| 04.  | [the-restart-page](https://github.com/michitaro/vue-menu)              | The Restart Page - Free unlimited rebooting experience from vintage operating systems                 | [here](http://www.therestartpage.com/#)                      |
| 05.  | [nextsite](https://github.com/juddy/nextsite)              | Simple HTML/CSS site mimicing some key NeXT Workspace elements: <br>   `CSS` `HTML` `JS` ~ [@juddy](https://github.com/juddy)                      | [here](https://prik-k.github.io/nextsite/)     |
...
| 08.  | Cyberspace & Time            | An old internet web portal                       | [here](http://cyberspaceandtime.com/ZgfM9bq2bOI.video+related)                      |
...
| 13.  | AConfusedDragon              | The classic gifs of old OS days             | [here](https://aconfuseddragon.neocities.org/index.html)                      |
...
| 04.  | [awesome-UNIX](https://github.com/sirredbeard/Awesome-UNIX)              | All the UNIX and UNIX-Like: Linux, BSD, macOS, Illumos, 9front, and more. <br>  `markdown` ~ [@sirredbeard](https://github.com/sirredbeard)                      | -                      |
